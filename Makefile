...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/29 15:11:17 by jmarguer          #+#    #+#              #
#    Updated: 2019/05/20 21:19:49 by jmarguer         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXTRA	= ft_absolute.c ft_is_prime.c ft_min.c ft_islower.c ft_isupper.c \
...
$(NAME):
	@gcc -I $(HEADER) -c -Wall -Wextra -Werror $(FILES)
	@ar rc $(NAME) $(OBJ)
	@ranlib $(NAME)
